...
const role_in_relationships_1 = __importDefault(require("../controllers/email/tests/role-in-relationships"));
...
mailerRouter.post('/role-in-relationships', role_in_relationships_1.default);
