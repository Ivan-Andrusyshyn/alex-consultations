...
const toxical_relationships_1 = __importDefault(require("../../services/toxical-relationships"));
...
const getNameCategoryByScore = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const categoryName = toxical_relationships_1.default.getNameCategoryByScore(answers);
