...
const getBenefitConsultation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const fileId = google_file_ids_env_1.BENEFIT_CONSULTATION;
...
exports.default = getBenefitConsultation;
