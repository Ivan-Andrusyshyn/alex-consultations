...
exports.roleInRelationshpsGetNameValidator = void 0;
const common_validator_1 = require("./common-validator");
const testsValidationCommonObject_1 = require("./testsValidationCommonObject");
const roleInRelationshpsGetNameValidator = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.roleInRelationshpsGetNameValidator = roleInRelationshpsGetNameValidator;
