...
const traumatic_experience_1 = __importDefault(require("./routes/traumatic-experience"));
const toxical_relationships_1 = __importDefault(require("./routes/toxical-relationships"));
...
const be_yourself_1 = __importDefault(require("./routes/be-yourself"));
const monopay_1 = __importDefault(require("./routes/monopay"));
const feedback_1 = __importDefault(require("./routes/feedback"));
const tests_user_data_1 = __importDefault(require("./routes/tests-user-data"));
...
server.use('/feedback', feedback_1.default);
server.use('/tests-user-data', tests_user_data_1.default);
server.use('/tests', you_coffee_1.default);
server.use('/tests', role_in_relationships_1.default);
server.use('/tests', be_yourself_1.default);
server.use('/tests', attractiveness_1.default);
server.use('/tests', toxical_relationships_1.default);
server.use('/tests', traumatic_experience_1.default);
